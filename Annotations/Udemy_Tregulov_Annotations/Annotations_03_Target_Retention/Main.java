package Annotations.Udemy_Tregulov_Annotations.Annotations_03_Target_Retention;

import java.lang.annotation.*;

public class Main {
    public static void main(String[] args) throws ClassNotFoundException {
        Class xiaomiClass = Class.forName("Annotations.Udemy_Tregulov_Annotations.Annotations_03_Target_Retention.Xiaomi");
        ...
        Class iphoneClass = Class.forName("Annotations.Udemy_Tregulov_Annotations.Annotations_03_Target_Retention.Iphone");
